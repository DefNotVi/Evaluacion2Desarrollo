...
android {
    namespace = "com.gwagwa.evaluacion2"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.gwagwa.evaluacion2"
        minSdk = 26 // downgradee esto porque en el duoc los emuladores son de esa version kjalkjhd
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    testImplementation("org.jetbrains.kotlin:kotlin-test-junit:1.9.0") // O l
